                            ...
                            while ($staff = mysqli_fetch_assoc($staff_result)) { ?>
                                <tr>
                                   ...
                                   <button class='btn btn-warning' style='border-radius:0%' data-toggle='modal' data-target='#changeShift'
                                           data-id=' {$staff['emp_id']} ' id='change_shift'>Change Shift</button>
                               </td>");
                                    ...
                                    <?php if( $_SESSION['role_id'] ==1){
                                       ...
                                       data-target='#empDetail {$staff['emp_id']} '
                                       data-id=' {$staff['emp_id']} ' id='editEmp'
                                      ...
                                      <?php if( $_SESSION['role_id'] ==1){
                                       echo("
                                        ...
                                        <a href='functionmis.php?empid= . {$staff['emp_id'] }.'
                                       class='btn btn-danger' onclick='return confirm('Are you Sure You Want To Delete ?')' style='border-radius:60px;'><i
                                    ...
                                    <a href='index.php?emp_history&empid= {$staff['emp_id']}'
